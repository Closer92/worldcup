...
echo "$($PSQL "SELECT t1.name AS team_name FROM games g JOIN teams t1 ON g.winner_id = t1.team_id OR g.opponent_id = t1.team_id WHERE g.year = 2014 AND g.round = 'Eighth-Final' ORDER BY t1.name ;")"
